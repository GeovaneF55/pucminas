public class MediaDiagonalMatriz{
   public static void main(String[] args){
      
      saudacao();
   
      int[][] matriz1 = new int[][]{{2,3,4},{3,4,5},{4,5,6}};
      double media1 = mediaDiagonal(matriz1);
      escreveResultado(media1);
      
      int[][] matriz2 = new int[][]{{20,20,40,40},{20,20,40,40},{20,20,40,40},{20,20,40,40}};
      double media2 = mediaDiagonal(matriz2);
      escreveResultado(media2);
      
      int[][] matriz3 = new int[][]{{2,3},{3,5}};
      double media3 = mediaDiagonal(matriz3);
      escreveResultado(media3);
   }
   
   public static void saudacao(){
      System.out.println("Cálculo da média da diagonal de uma matriz!\n");
   }
   
   public static double mediaDiagonal(int[][] matriz){
      int i, j, soma=0;
      double media=0;
