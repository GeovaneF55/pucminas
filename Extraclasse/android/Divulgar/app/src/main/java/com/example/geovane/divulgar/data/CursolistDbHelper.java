...
public class CursolistDbHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_CURSO_TABLE = "CREATE TABLE " +
                CursolistCotract.CursolistEntry.TABLE_NAME + "(" +
                CursolistCotract.CursolistEntry._ID + "  INTEGER PRIMARY KEY AUTOINCREMENT," +
                CursolistCotract.CursolistEntry.COLUMN_CURSO_NAME + " TEXT NOT NULL" +
                ");";

        sqLiteDatabase.execSQL(SQL_CREATE_CURSO_TABLE);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + CursolistCotract.CursolistEntry.TABLE_NAME);
