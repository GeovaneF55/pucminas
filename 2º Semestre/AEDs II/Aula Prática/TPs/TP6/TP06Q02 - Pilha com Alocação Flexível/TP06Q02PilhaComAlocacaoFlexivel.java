/**
 * TP06Q02 - Pilha com Alocação Flexível
 * @author Geovane Fonseca de Sousa Santos
 * @version 1 10/2016
 */
class TP06Q02PilhaComAlocacaoFlexivel{
...
class Celula {
	public Pessoa pessoa; // Elemento inserido na celula.
...
class Pilha {
	...
	public Pessoa remover() throws Exception {
		...
		Pessoa resp = topo.pessoa.clonar();
		Celula tmp = topo;
		topo = topo.prox;
		tmp.prox = null;
		tmp = null;
