...
class Pilha {
	...
	public void inserir(Pessoa pessoa) throws Exception {
		...
		//validar insercao
		if(getTopo() >= array.length){
			throw new Exception("Erro ao inserir!");
		}

		array[getTopo()] = pessoa.clone();
		setTopo(getTopo()+1);
	}
	...
	public Pessoa remover() throws Exception {
		...
		return array[getTopo()];
	}


	/**
	 * Mostra os elementos do array separados por quebra de linha.
	 */
	public void mostrar(){
