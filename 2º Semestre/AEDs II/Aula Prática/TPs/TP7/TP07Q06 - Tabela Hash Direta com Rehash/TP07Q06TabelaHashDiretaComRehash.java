/**
 * TP07Q06 - Tabela Hash Direta Com Rehash
...
class TP07Q06TabelaHashDiretaComRehash{
	static HashDiretaComRehash hash = new HashDiretaComRehash();
	...
	*/
	public static void log(){
		Arq.openWrite(MATRICULA + "_hashRehash.txt");
...
class HashDiretaComRehash {
	Pessoa tabela[];
	int m;
	Pessoa NULO = null;

	public HashDiretaComRehash (){
		this(21);
	}

	public HashDiretaComRehash (int m){
		this.m = m;
	...
	public boolean inserir (Pessoa pessoa){
		...
		if(pessoa != NULO){
			...
			if(tabela[pos] == NULO){
				TP07Q06TabelaHashDiretaComRehash.COMPARACOES+=1;
				tabela[pos] = pessoa.clone();
				resp = true;

			} else{
				TP07Q06TabelaHashDiretaComRehash.COMPARACOES+=1;
				pos = reh(pessoa.getId());
