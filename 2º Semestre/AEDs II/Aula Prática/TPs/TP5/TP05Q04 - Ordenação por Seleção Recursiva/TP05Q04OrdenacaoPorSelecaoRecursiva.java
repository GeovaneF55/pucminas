/**
 * TP05Q04 - Ordenação por Seleção Recursiva
...
class TP05Q04OrdenacaoPorSelecaoRecursiva{
	...
	public static void main(String[] args) throws Exception{
		...
		COMECO = now();
		lista.ordenacaoSelecaoRecursiva();
		FIM = now();
...
class Lista {
	...
	/**
         ...
         */
        public void ordenacaoSelecaoRecursiva(){
		ordenacaoSelecaoRecursiva(0);
	}

	public void ordenacaoSelecaoRecursiva(int i){
		if(i < getQtde()){
			int menor = pesquisaOrdenacaoSelecaoRecursiva(i, i+1);
			swap(menor, i);
			ordenacaoSelecaoRecursiva(i+1);
		}
	}

	public int pesquisaOrdenacaoSelecaoRecursiva(int menor, int j){
		int retorno = menor;
		if(j < getQtde()){
			if(array[menor].getId() > array[j].getId()){
				menor = j;
			}
			TP05Q04OrdenacaoPorSelecaoRecursiva.COMPARACOES+=1;
			retorno = pesquisaOrdenacaoSelecaoRecursiva(menor, j+1);
		}
		return retorno;
	}
	...
	public void swap(int menor, int i) {
		...
		TP05Q04OrdenacaoPorSelecaoRecursiva.MOVIMENTACOES+=3;
	}
}
