...
class MyWidget(QWidget):
	...
	def my_label(self, p):
		if coord1 is None:
			return ('Current coordinates: ( %d : %d ) - Click 1: None - Click 2: None' % (p.x(), p.y()))
		elif coord2 is None:
			return ('Current coordinates: ( %d : %d ) - Click 1: ( %d : %d) - Click 2: None' % (p.x(), p.y(), coord1.x(), coord1.y()))
		else:
			return ('Current coordinates: ( %d : %d ) - Click 1: ( %d : %d) - Click 2: ( %d : %d )' % (p.x(), p.y(), coord1.x(), coord1.y(), coord2.x(), coord2.y()))
